          ...
          <div class='navbar-fixed '>
              <nav>
                  <div class='nav-wrapper blue'>
                      <a href='index9ba3.html?page=home' class='hide-on-small-only brand-logo'><span class='red-text text-darken-3'>E</span><span class='blue-text text-darken-4'>Sports</span> <span class='amber-text text-lighten-1'>Gaming</span> <small class='blue-text text-lighten-4'>COD4</small></a>
                      ...
                      <ul class='right hide-on-med-and-down'>
                          ...
                          <li><a href='index.html' class='tooltipped' data-position='bottom' data-delay='0' data-tooltip='Delete cache and reload'><i class='mdi-navigation-refresh'></i></a></li>


                          <li style='margin-left:1rem;'><a href='index95e4.html'><i class='mdi-editor-format-list-numbered left'></i>Banlist</a></li>
